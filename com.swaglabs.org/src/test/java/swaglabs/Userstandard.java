...
public class Userstandard {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(3000);
		category = driver.findElement(By.xpath("//*[@data-test='product-sort-container']"));
		Select selection1 = new Select(category);
		selection1.selectByValue("lohi");
		Thread.sleep(4000);
		category = driver.findElement(By.xpath("//*[@data-test='product-sort-container']"));
		Select selection2 = new Select(category);
		selection2.selectByValue("hilo");
		Thread.sleep(3000);
		category = driver.findElement(By.xpath("//*[@data-test='product-sort-container']"));
		Select selection3 = new Select(category);
		selection3.selectByVisibleText("Name (A to Z)");
		Thread.sleep(3000);
		...
		driver.findElement(By.xpath("(//*[@class='inventory_item_img'])[4]")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("//*[@id='add-to-cart']")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("//*[@id='back-to-products']")).click();
		...
		String str = driver.findElement(By.xpath("(//*[@class='shopping_cart_badge'])")).getText();
		...
		String str1 = driver.findElement(By.xpath("(//*[@class='shopping_cart_badge'])")).getText();
